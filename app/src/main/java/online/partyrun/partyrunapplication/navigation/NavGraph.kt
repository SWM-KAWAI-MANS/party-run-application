...
fun SetUpNavGraph(
    ...
    NavHost(
        ...
        test2Route(
            navigateToTest3 = {
                navController.navigate(NavRoutes.Test3.route) {
                    popUpTo(NavRoutes.Test3.route)
                }
            }
        )
        test3Route()
...
fun NavGraphBuilder.test1Route(
    ...
    composable(route = NavRoutes.Test1.route) {
        Test1Screen(
...
fun NavGraphBuilder.test2Route(
     ...
     */
    composable(
        route = "${NavRoutes.Test2.route}?userName={userName}",
...
fun NavGraphBuilder.test4Route() {
    composable(route = NavRoutes.Test4.route) {
        Test4Screen()
    }
}
